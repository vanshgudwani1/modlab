...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      let gl: WebGL2RenderingContext | WebGLRenderingContext | any = canvas.getContext('webgl2', params);
    ...
    // To prevent reference errors across the file, we get context here globally
    ...
    function setup() {
      ...
      if (!ext?.supportLinearFiltering) {
        ...
        config.COLOR_UPDATE_SPEED = Math.max(config.COLOR_UPDATE_SPEED, 8);
      }
